...
<body>
    ...
    <div class="container">
        ...
        <p class="subheader">Enter your current and new passwords</p>
            ...
            <div class="form-group">
                ...
                <div class="password-wrapper">
                    <input
                        ...
                        autofocus
                    >
                    <button type="button" class="toggle-pwd" onclick="togglePassword('oldPassword')">Show</button>
                </div>
            </div>
    ...
    <script>
        ...
        async function handleSubmit(event) {
            ...
            try {
                const response = await fetch('{{ route("password.verify-old-password") }}', {
                    method: 'POST',
                    headers: {
