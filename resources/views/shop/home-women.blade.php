...
<div class="home-container">
    ...
    <div class="subcategory-group">
        ...
        <div class="subcategory-cards-grid">
            ...
            @foreach([
                ['tops','Tops','Refined elegance with understated sophistication.','tops.jpg'],
                ['Crop tops','Crop T-Shirts','Contemporary design meets timeless classical grace.','croptop.jpeg'],
                ['shirts','Shirts','Timeless tailoring infused with modern feminine grace.','shirts.jpg'],
                ['sweatshirts','Sweaters','Classic warmth wrapped in sophisticated luxury design.','sweater.jpg'],
            ] as [$cat,$name,$tag,$img])
    ...
    <div class="subcategory-group">
        ...
        <div class="subcategory-cards-grid">
            ...
            @foreach([
                ['jeans','Jeans','Legendary denim refined with timeless elegant essence.','jeans.jpg'],
                ['SweatPants','Sweat Pants','Comfortable luxury meets classical refined style here.','swt.jpg'],
                ['Half Skirts','Half Skirts','Elegantly crafted for the refined modern woman.','skirt.jpg'],
                ['Long skirts','Long Skirts','Flowing elegance embodied in timeless classical design.','lskirt.jpg'],
            ] as [$cat,$name,$tag,$img])
            <a href="{{ route('products.index',['category'=>$cat,'gender'=>'women']) }}" class="subcategory-card">
                <div class="subcategory-card-image">
                    <img src="{{ asset('images/'.$img) }}" alt="{{ $name }}">
