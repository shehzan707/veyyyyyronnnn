<?php $__env->startSection('title', 'VEYRON — Shop'); ?>
    ...
    <div class="main-content">
        <div class="products-container">
            ...
            <?php if($categoryTitle): ?>
                <h1 class="category-curated-title <?php echo e($genderFromUrl); ?>"><?php echo e($categoryTitle); ?></h1>
            <?php endif; ?>

            <!-- Product Count Display -->
            <div class="product-count-display">
                Showing <strong id="productCountDisplay"><?php echo e($products->count()); ?></strong> products
            </div>
                        ...
                        <a href="<?php echo e(route('products.show', $product->id)); ?>">
                            <div class="product-image">
                                ...
                                <div class="product-overlay">
                                    <button class="overlay-btn add-btn" onclick="event.stopPropagation(); addToCart(<?php echo e($product->id); ?>)" type="button">Add to Bag</button>
                                </div>
                                
                                <button class="overlay-btn wish-btn" onclick="event.stopPropagation(); event.preventDefault(); addToWishlist(<?php echo e($product->id); ?>); return false;" type="button" title="Add to Wishlist">
                            ...
                            <div class="product-info">
                                <div class="product-category">
                                    <?php if($product->categoryModel): ?>
                                        <?php if($product->categoryModel->parent): ?>
                                            <?php echo e($product->categoryModel->parent->name); ?> - <?php echo e($product->categoryModel->name); ?>

                                        <?php else: ?>
                                            <?php echo e($product->categoryModel->name); ?>
...
const categoryData = <?php echo json_encode($categoryGroups ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Veyronnnnnnnnnn\resources\views/shop/products.blade.php ENDPATH**/ ?>