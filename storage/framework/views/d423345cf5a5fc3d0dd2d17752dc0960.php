...
<head>
    <meta charset="UTF-8">
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard — VEYRON'); ?></title>
...
<body>
    <header class="header">
        <div class="logo">
            <img src="<?php echo e(asset('images/adminlogo.png')); ?>" alt="VEYRON Logo">
...
<?php /**PATH C:\Veyronnnnnnnnnn\resources\views/layouts/admin.blade.php ENDPATH**/ ?>