<?php $__env->startSection('title', $product->name . ' — VEYRON'); ?>
...
<div class="product-detail">
    ...
    <div class="product-info">
        <span class="product-category"><?php echo e(ucwords(str_replace('-', ' ', $product->category))); ?></span>
        ...
        <form id="addToCartForm">
          ...
          <?php if(!$isSingleSizeB): ?>
    <label><strong>Select Size</strong></label>
    <br>
<?php endif; ?>

<div class="size-selector<?php echo e($isSingleSizeB ? ' hidden' : ''); ?>">
    <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="size-option <?php echo e($classStr); ?>"
             data-size="<?php echo e($size); ?>"
             data-stock="<?php echo e($stockData[$size]); ?>"
             <?php if($stockData[$size] == 0): ?> data-disabled="true" <?php endif; ?>>
            <?php echo e($size); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <input type="hidden" id="selectedSize" value="<?php echo e($isSingleSizeB ? 'B' : ''); ?>">
...
document.getElementById('wishlistBtn').addEventListener('click', function () {
    ...
    fetch(`/wishlist/add/<?php echo e($product->id); ?>`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Veyronnnnnnnnnn\resources\views/shop/product-detail.blade.php ENDPATH**/ ?>