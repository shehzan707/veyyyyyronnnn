...
<body>
    ...
    <div class="container">
        ...
        <div class="user-info">
            <p>Account: <strong><?php echo e($user->email ?? $user->mobile); ?></strong></p>
        </div>
    ...
    <script>
        ...
        async function generateOtpAndProceed(userId) {
            try {
                const response = await fetch('<?php echo e(route("password.generate-otp")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php /**PATH C:\Veyronnnnnnnnnn\resources\views/auth/reset-method.blade.php ENDPATH**/ ?>