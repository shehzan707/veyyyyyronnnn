...
<div class="veyron-banner-carousel-wrapper">
    ...
    <div class="veyron-banner-carousel" id="veyronBannerCarousel">
        <?php $__empty_1 = true; $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="carousel-slide <?php echo e($index === 0 ? 'active' : ''); ?>" data-index="<?php echo e($index); ?>">
                <div class="slide-content">
                    <?php if($banner->media_type === 'image'): ?>
                        <img src="<?php echo e(asset($banner->file_path)); ?>" 
                             alt="<?php echo e($banner->file_name); ?>" 
                             class="banner-media"
                             data-type="image">
                    <?php elseif($banner->media_type === 'video'): ?>
                        <video class="banner-media" data-type="video" playsinline muted autoplay loop preload="metadata">
                            ...
                            <source src="<?php echo e(asset(str_replace('.mp4', '.webm', $banner->file_path))); ?>" type="video/webm">
                ...
                ?>
                <a href="<?php echo e($linkUrl); ?>" class="slide-link-overlay" title="View products"></a>
            </div>
    ...
    <?php if($banners->count() > 1): ?>
        ...
        <div class="carousel-indicators">
            <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button class="indicator-dot <?php echo e($index === 0 ? 'active' : ''); ?>" 
...
<?php /**PATH C:\Veyronnnnnnnnnn\resources\views/components/banner-carousel.blade.php ENDPATH**/ ?>