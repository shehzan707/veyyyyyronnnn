...
<h2 style="margin-bottom: 25px;">Order #<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?></h2>

<div class="order-card">
    <div class="order-header">
        <div>
            <span style="color:#ffffff;">Order Date:</span>
            <strong style="color:#ffffff;"><?php echo e($order->created_at->format('d M Y, h:i A')); ?></strong>
        </div>
        <form action="<?php echo e(route('admin.orders.status', $order->id)); ?>" method="POST" class="status-form">
            ...
            <select name="order_status">
                ...
                <option value="out_for_delivery" <?php echo e($order->order_status == 'out_for_delivery' ? 'selected' : ''); ?>>Out for Delivery</option>
    ...
    <div class="order-grid">
        <div>
            ...
            <div class="info-group">
                ...
                <div class="info-value"><?php echo e($order->name); ?></div>
            </div>
            <div class="info-group">
            ...
            <div class="info-group">
                ...
                <div class="info-value"><?php echo e($order->mobile); ?></div>
            </div>
        </div>
        <div>
            ...
            <div class="info-group">
                ...
                <div class="info-value"><?php echo e($order->city); ?>, <?php echo e($order->state); ?> - <?php echo e($order->pincode); ?></div>
            </div>
            <div class="info-group">
                <div class="info-label">Payment Method</div>
                <div class="info-value"><?php echo e($order->payment_method == 'cod' ? 'Cash on Delivery' : 'Online Payment'); ?></div>
            </div>
        </div>
    </div>
</div>
    ...
    <table class="items-table">
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <tr class="<?php echo e($isCancelled ? 'cancelled' : ''); ?>">
        ...
        <tfoot>
            <?php if($cancelledTotal > 0): ?>
            <tr>
                <td colspan="5" style="text-align:right; font-weight:700; color: #dc3545;">Cancelled Total:</td>
                <td style="font-weight:700; font-size:1.1rem; color: #dc3545;">₹<?php echo e(number_format($cancelledTotal, 2)); ?></td>
                <td></td>
            </tr>
            <?php endif; ?>
            <tr>
                <td colspan="5" style="text-align:right; font-weight:700;">Grand Total:</td>
                <td style="font-weight:700; font-size:1.2rem;">₹<?php echo e(number_format($activeTotal, 2)); ?></td>
                <td></td>
            </tr>
        </tfoot>
    </table>
...
<a href="<?php echo e(route('admin.orders.index')); ?>" class="back-link">← Back to Orders</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Veyronnnnnnnnnn\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>