                ...
                <td>
                    <div style="display: flex; align-items: center;">
                        <label class="toggle-switch">
                            <input type="checkbox" class="status-toggle" data-user-id="<?php echo e($user->id); ?>" <?php echo e($user->is_active ? 'checked' : ''); ?> onchange="toggleUserStatus(event, <?php echo e($user->id); ?>)">
                            <span class="toggle-slider"></span>
                        </label>
                        <span class="status-text <?php echo e(!$user->is_active ? 'inactive' : ''); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Veyronnnnnnnnnn\resources\views/admin/users/index.blade.php ENDPATH**/ ?>