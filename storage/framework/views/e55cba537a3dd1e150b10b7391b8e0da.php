<?php $__env->startSection('title', 'Shopping Cart — VEYRON'); ?>
...
<div class="container">
        ...
        <div class="cart-layout">
                ...
                <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="cart-item">
                        <div style="position:relative; width:120px;">
                            <a href="<?php echo e(isset($item['id']) ? route('products.show', $item['id']) : '#'); ?>" style="display:inline-block;">
                                <img src="<?php echo e(asset($item['image'])); ?>" alt="<?php echo e($item['name']); ?>" style="width:120px; height:150px; object-fit:cover; border-radius:8px;">
                            </a>
                            <button type="button" class="cart-remove-cross" title="Remove from cart" data-cart-key="<?php echo e($id); ?>" style="position:absolute; top:-32px; right:-640px;">
                                    ...
                                    .then(res => {
                                        if (res.ok) {
                                            ...
                                            if (document.querySelectorAll('.cart-item').length === 0) {
                                                document.querySelector('.cart-items').innerHTML = `<div class="empty-cart"><h2 style=\"font-weight:700;\">Hey, it feels so light!</h2><p style=\"color:rgba(34,34,34,0.5); margin:20px 0; font-size:1.1rem;\">Let's add some items</p><a href=\"<?php echo e(route('products.index')); ?>\" style=\"display:inline-block; margin-top:18px; padding:12px 32px; background:#222; color:#fff; border-radius:8px; font-weight:600; text-decoration:none; font-size:1rem; box-shadow:0 2px 8px rgba(0,0,0,0.08); transition:background 0.2s;\">Add Item</a></div>`;
                                            }
                                        }
                                    });
                                });
                        ...
                        <div class="cart-item-info">
                            <span class="cart-item-name"><?php echo e($item['name']); ?></span>
                            <span class="cart-item-meta">
                                <?php if(!empty($item['size'])): ?> Size: <?php echo e($item['size']); ?> <?php endif; ?>
                            </span>
                            <span class="cart-item-price">₹<?php echo e(number_format($item['price'], 2)); ?></span>
                            <div class="cart-item-actions">
                                <div class="qty-control" data-cart-key="<?php echo e($id); ?>" data-stock="<?php echo e($stock); ?>" data-product-id="<?php echo e($item['id']); ?>" data-size="<?php echo e($item['size'] ?? 'default'); ?>">
            ...
            <div class="cart-summary" style="background:#fff; border-radius:12px; padding:24px 20px; box-shadow:0 2px 10px rgba(233,30,99,0.08);">
                ...
                <div class="summary-row summary-total" style="font-size:1.25rem; font-weight:700; color:#000;">
                    ...
                    <span id="total-amount-value">₹<?php echo e(number_format($totalAmount, 0)); ?></span>
                </div>
                <form action="<?php echo e(route('checkout.index')); ?>" method="get" style="margin:0;">
    ...
    <?php else: ?>
        <div class="empty-cart">
            ...
            <a href="<?php echo e(route('products.index')); ?>" style="display:inline-block; margin-top:18px; padding:12px 32px; background:#222; color:#fff; border-radius:8px; font-weight:600; text-decoration:none; font-size:1rem; box-shadow:0 2px 8px rgba(0,0,0,0.08); transition:background 0.2s;">Add Item</a>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Veyronnnnnnnnnn\resources\views/shop/cart.blade.php ENDPATH**/ ?>