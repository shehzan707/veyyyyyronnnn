...
<?php $__env->startSection('title', 'My Account — VEYRON'); ?>
            ...
            <div class="user-profile">
                <div class="user-avatar" id="profilePreview">
                    <?php if($user->profile_picture): ?>
                        <img src="<?php echo e(asset('uploads/profiles/' . $user->profile_picture)); ?>" alt="Profile">
                    <?php else: ?>
                        <span><?php echo e(strtoupper(substr($user->first_name, 0, 1))); ?></span>
                    <?php endif; ?>
                </div>
                ...
                <div class="user-name" id="profileName"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></div>
                <div class="user-email" id="profileEmail"><?php echo e($user->email); ?></div>
            </div>
            <nav>
                <a href="<?php echo e(route('account.index')); ?>" style="display: block; padding: 12px 0; text-decoration: none; border-bottom: 1px solid #eee; color: #222;">My Account</a>
                <a href="<?php echo e(route('wishlist.index')); ?>" style="display: block; padding: 12px 0; text-decoration: none; border-bottom: 1px solid #eee; color: #666;">Wishlist</a>
                <a href="<?php echo e(route('logout')); ?>" style="display: block; padding: 12px 0; text-decoration: none; color: #666;">Logout</a>
            </nav>
        </aside>
        ...
        <div class="account-content">
            ...
            <div id="profile" class="tab-content active">
                <div class="form-section">
                    ...
                    <form method="POST" action="<?php echo e(route('account.updateProfile')); ?>" enctype="multipart/form-data" id="profileForm">
                        <?php echo csrf_field(); ?>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" name="mobile" value="<?php echo e(old('mobile', $user->mobile)); ?>" maxlength="10" pattern="[0-9]{10}" required>
                            </div>
                        </div>
            ...
            <div id="addresses" class="tab-content">
                <div class="form-section">
                    ...
                    <?php if($addresses->count() > 0): ?>
                        <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="address-card" <?php echo e($address->is_default ? 'style="border: 2px solid #222; background: #f9f9f9;"' : ''); ?>>
                                ...
                                <div class="address-content">
                                    <p><?php echo e($address->address_line_1); ?><?php if($address->address_line_2): ?>, <?php echo e($address->address_line_2); ?><?php endif; ?></p>
                                    <p><?php echo e($address->city); ?>, <?php echo e($address->state); ?> <?php echo e($address->postal_code); ?></p>
                                    <p><?php echo e($address->country); ?> | <?php echo e($address->phone); ?></p>
                                </div>
                                <div class="address-actions">
                                    <button class="btn-secondary" type="button" onclick="editAddressForm(<?php echo e($address->id); ?>)">Edit</button>
                                    <form method="POST" action="<?php echo e(route('account.deleteAddress', $address->id)); ?>" style="display: inline;" onsubmit="return confirm('Delete this address?')">
                                        <?php echo csrf_field(); ?>
                ...
                <div class="form-section">
                    ...
                    <form method="POST" action="<?php echo e(route('account.addAddress')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="order-card">
                                <div class="order-header">
                                    <span class="order-id">Order #<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?></span>
                                    <span class="order-status status-<?php echo e($order->order_status); ?>"><?php echo e(ucfirst($order->order_status)); ?></span>
                                </div>
                                <div style="display:flex; justify-content:space-between; color:#666; margin-bottom: 12px;">
                                    ...
                                    <span style="font-weight:700; color:#222;">₹<?php echo e(number_format($actualTotal, 2)); ?></span>
                                </div>
                                <a href="<?php echo e(route('account.order.view', $order->id)); ?>" style="display:inline-block; color:#222; text-decoration:underline;">View Details →</a>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php else: ?>
                    <div style="text-align:center; padding:50px;">
                        ...
                        <a href="<?php echo e(route('products.index')); ?>" style="color:#222; text-decoration:underline;">Start Shopping</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
function saveCropImage() {
    if (cropper) {
        ...
        canvas.toBlob(function(blob) {
            ...
            fetch('<?php echo e(route("account.updateProfile")); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Veyronnnnnnnnnn\resources\views/shop/account.blade.php ENDPATH**/ ?>